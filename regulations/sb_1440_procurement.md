# SB 1440 Biomethane Procurement Targets

Senate Bill (SB) 1440, implemented through California Public Utilities Commission (CPUC) Decision D.22-02-025, established biomethane procurement requirements for California’s large investor-owned gas utilities to reduce short-lived climate pollutant emissions and support organic waste diversion goals as mandated by [SB 1383](sb_1383_methane.md) [1](#ref-1) [5](#ref-5).
...
The total procurement targets are allocated among California's four large investor-owned utilities based on their 2021 Cap-and-Trade allowance shares [2](#ref-2):
...
SoCalGas is implementing its biomethane procurement plan in accordance with CPUC mandates to transition its gas supply toward renewable sources [3](#ref-3).
...
## PG&E Implementation
PG&E has submitted a Draft Renewable Gas Procurement Plan (RGPP) to comply with SB 1440 and CPUC requirements [6](#ref-6).

### Procurement Targets
*   **Short-term (2025-2029):** PG&E's annual procurement target is 7.452 Bcf [6](#ref-6).
*   **Medium-term (2030-2040):** PG&E's annual procurement target increases to 27.745 Bcf [6](#ref-6).

### Implementation Strategy
*   **Procurement Methods:** PG&E utilizes a combination of competitive RFOs and bilateral negotiations to procure biomethane [6](#ref-6).
*   **Governance and Feedback:** A Procurement Advisory Group (PAG) provides informal feedback on PG&E's procurement strategy and supplier selection process [6](#ref-6).
*   **Cost Containment:** The implementation includes a three-tier Advice Letter approval process for contracts, based on the price per MMBtu relative to established market benchmarks [6](#ref-6).
*   **Current Status:** As of early 2026, PG&E's dedicated RNG solicitation portal lists future RFOs as "Coming soon" [7](#ref-7).
...
<a id="ref-3"></a>
[3] : https://www.socalgas.com/sustainability/renewable-gas/rng-procurement

<a id="ref-4"></a>
[4] : https://www.socalgas.com/sustainability/renewable-gas/rng-procurement/sb1440-solicitation

<a id="ref-5"></a>
[5] : https://docs.cpuc.ca.gov/PublishedDocs/Published/G000/M454/K691/454691169.PDF
