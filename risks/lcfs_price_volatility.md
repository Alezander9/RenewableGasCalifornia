...
- **Debt Sizing and Bankability:** Investors and lenders often base the "bankable" revenue stream on the lowest projected credit price due to the lack of a price floor. This significantly reduces the amount of debt a project can carry compared to traditional infrastructure projects [1](#ref-1).
- **Revenue Uncertainty:** Unlike tax credits with defined periods (e.g., 45Q's 12-year limit), LCFS credits have longer lives but much higher price uncertainty, making long-term financial modeling speculative [1](#ref-1).
...
<a id="ref-1"></a>
[1] : https://stillwaterpublications.com/225400-2/

<a id="ref-2"></a>
[2] : https://stillwaterpublications.com/outlook-samples/cdn-cfr-sample/
